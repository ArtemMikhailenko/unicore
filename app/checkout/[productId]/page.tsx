    ...
    <main className="w-full min-h-screen bg-[#0A0218] flex justify-center py-[50px] 2xl:py-[70px]">
      <div className="w-full max-w-[1132px] lg:max-w-none lg:px-[10%] flex flex-col gap-[30px] 2xl:gap-[40px] px-4">
        ...
        <nav className="flex items-center gap-[15px]">
          <Link 
            href="/products"
            className="text-[12px] md:text-[16px] 2xl:text-[18px] leading-[160%] text-[#737AAE] hover:text-white transition-colors"
          >
            Products
          </Link>
          ...
          <span className="text-[12px] md:text-[16px] 2xl:text-[18px] leading-[160%] text-white">
            Payment Methods
          </span>
        </nav>
        ...
        <div className="flex flex-col lg:flex-row gap-[32px] 2xl:gap-[48px]">
          ...
          <div className="w-full lg:w-[60%] flex flex-col gap-[20px] 2xl:gap-[30px]">
            ...
            <div className="flex items-center gap-[15px] 2xl:gap-[20px]">
              <div className="w-[42px] h-[42px] md:w-[64px] md:h-[64px] 2xl:w-[80px] 2xl:h-[80px] bg-[#0D0525] rounded-[15px] flex items-center justify-center overflow-hidden">
                <Image
                  src="/images/products/genshin-logo.png"
                  alt="Genshin Impact"
                  width={64}
                  height={64}
                  className="w-[42px] h-[42px] md:w-[64px] md:h-[64px] 2xl:w-[80px] 2xl:h-[80px] object-cover"
                />
              </div>
              <div className="flex flex-col md:gap-[5px]">
                <h1 
                  className="text-[14px] lg:text-[32px] 2xl:text-[42px] md:leading-[44px] 2xl:leading-[52px] font-bold text-white"
                  style={{ fontFamily: 'var(--font-hywenhei, system-ui)' }}
                >
                  Genshin Impact
                </h1>
                <span className="text-[12px] text-[16px] 2xl:text-[18px] text-[#737AAE] leading-[160%]">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-[20px] 2xl:gap-[25px]">
          ...
          <div className="w-full lg:w-[40%] flex flex-col gap-[20px] 2xl:gap-[30px]">
            {/* Checkout Card */}
             <h2 
                className="text-[24px] lg:text-[36px] 2xl:text-[48px] leading-[44px] 2xl:leading-[56px] font-bold text-white ml-[25px] lg:ml-0"
                style={{ fontFamily: 'var(--font-hywenhei, system-ui)' }}
              >
                Check Out
              </h2>
            <div className="w-full bg-[#0D0525] rounded-[20px] p-[30px] 2xl:p-[40px] flex flex-col gap-[20px] 2xl:gap-[25px]">
              ...
              <div className="flex items-center justify-between">
                <span className="text-[14px] lg:text-[18px] 2xl:text-[22px] text-[#ffffff]">Service Fee</span>
                <span className="text-[14px] lg:text-[16px] 2xl:text-[20px] text-[#737AAE]">10%</span>
              </div>

              {/* Discount */}
              <div className="flex flex-col gap-[10px]">
                <div className="flex items-center justify-between">
                  <span className="text-[14px] lg:text-[18px] 2xl:text-[22px] text-[#ffffff]">Discount</span>
                  <span className="text-[14px] lg:text-[16px] 2xl:text-[20px] text-[#737AAE]">25%</span>
                </div>
                <div className="flex gap-[10px]">
                  <div className="relative flex-1">
                    <input
                      ...
                      className="w-full h-[46px] 2xl:h-[56px] bg-[#100A36] border border-[#1D1550] rounded-[10px] pl-[15px] pr-[35px] text-[14px] 2xl:text-[16px] text-white placeholder:text-[#737AAE] focus:border-[#FFC260] outline-none transition-colors"
                    />
                    <svg 
                  ...
                  <button className="w-[100px] 2xl:w-[120px] h-[46px] 2xl:h-[56px] bg-[#FFC260] rounded-[10px] text-[16px] 2xl:text-[18px] font-semibold text-[#6E3B08] hover:bg-[#FFD280] transition-colors">
                    Apply
                  </button>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between pt-[20px] border-t border-[#1D1550]">
                <span className="text-[14px] lg:text-[18px] 2xl:text-[22px] font-semibold text-white">Total</span>
                <div className="flex items-center gap-2">
                  <span className="text-[14px] lg:text-[18px] 2xl:text-[22px] font-semibold text-[#737AAE] line-through">$2</span>
                  <span className="text-[14px] lg:text-[18px] 2xl:text-[22px] font-semibold text-white">$10</span>
                </div>
              </div>
              ...
              <input
                ...
                className="w-full h-[46px] 2xl:h-[56px] bg-[#100A36] border border-[#1D1550] rounded-[10px] px-[15px] text-[14px] 2xl:text-[16px] text-white placeholder:text-[#737AAE] focus:border-[#FFC260] outline-none transition-colors"
              />
              ...
              <button 
                ...
                className="w-full h-[46px] 2xl:h-[56px] bg-[#FFC260] rounded-[10px] text-[18px] 2xl:text-[22px] font-semibold text-[#6E3B08] hover:bg-[#FFD280] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Go to Payment
              </button>

              {/* Terms */}
              <p className="text-[10px] 2xl:text-[12px] text-[#737AAE] text-center leading-[140%]">
            ...
            <div className="w-full flex flex-col gap-[10px]">
              <h3 
                className="text-[24px] 2xl:text-[32px] lg:ml-[30px] leading-[44px] font-bold text-white ml-[25px] lg:ml-0"
                style={{ fontFamily: 'var(--font-hywenhei, system-ui)' }}
              >
                Need Help?
              </h3>
              ...
              <div className="w-full bg-[#0D0525] rounded-[30px] p-[30px] 2xl:p-[40px] flex flex-col gap-[20px] 2xl:gap-[25px]">
                <p className="text-[16px] 2xl:text-[18px] text-[#737AAE] leading-[160%]">
                ...
                <button className="w-full h-[46px] 2xl:h-[56px] bg-[#100A36] border border-[#1D1550] rounded-[10px] text-[18px] 2xl:text-[22px] font-semibold text-[#737AAE] hover:border-[#FFC260] hover:text-white transition-colors">
