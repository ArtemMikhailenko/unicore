    ...
    <main className="w-full min-h-[70vh] bg-[#0A0218] flex justify-center py-[30px] lg:py-[50px]">
      <div className="w-full max-w-[1132px] flex flex-col gap-[30px] px-4 lg:px-0">
        ...
        <nav className="flex items-center gap-[5px]">
          <Link 
            href="/products"
            className="text-[12px] lg:text-[16px] leading-[160%] text-[#737AAE] hover:text-white transition-colors"
          >
            Products
          </Link>
          ...
          <span className="text-[12px] lg:text-[16px] leading-[160%] text-white">
            Resellers
          </span>
        </nav>
        ...
        <div className="flex flex-col gap-[15px] lg:gap-[20px]">
          ...
          <div className="flex items-center gap-[15px] pb-[10px]">
            <div className="w-[42px] h-[42px] lg:w-[64px] lg:h-[64px] bg-[#0D0525] flex items-center justify-center overflow-hidden">
              <Image
            ...
            <div className="flex flex-col gap-[0px]">
              <h1 
                className="text-[16px] lg:text-[36px] leading-[29px] lg:leading-[44px] font-bold text-white"
                style={{ fontFamily: 'var(--font-hywenhei, system-ui)' }}
              >
                Genshin Impact
              </h1>
              <span className="text-[12px] lg:text-[16px] text-[#737AAE] leading-[160%]">
          ...
          <h2 
            className="hidden lg:block text-[36px] leading-[44px] font-bold text-white"
            style={{ fontFamily: 'var(--font-hywenhei, system-ui)' }}
          >
            Resellers
          </h2>
          ...
          {/* Resellers Grid */}
          <div className="grid grid-cols-2 lg:grid-cols-2 gap-[16px] lg:gap-[20px]">
            {resellers.map((reseller) => (
              <a
                ...
                className="w-full h-[75px] lg:h-[84px] bg-[#100A36] border border-[#1D1550] rounded-[15px] p-[20px] flex items-center gap-[10px] hover:border-[#FFC260] transition-colors"
              >
                ...
                <div className="flex flex-col items-start justify-center gap-[0px] flex-1 min-w-0">
                  <span className="text-[14px] lg:text-[18px] font-semibold text-white leading-[20px]">
                    {reseller.name}
                  </span>
                  <span className="text-[8px] lg:text-[12px] text-[#737AAE] leading-[11px]">
