...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-[#0d0525]">
      <div className="w-full flex items-start justify-center py-[30px] lg:py-[40px] 2xl:py-[80px] 3xl:py-[105px] px-4 lg:px-[20%]">
        <div className="w-full max-w-[1132px] lg:max-w-none flex flex-col lg:flex-row items-start justify-between gap-[29px] lg:gap-8 2xl:gap-16 3xl:gap-32">
          ...
          <div className="flex flex-col gap-[29px] lg:gap-4 2xl:gap-8 3xl:gap-16 max-w-[577px] 2xl:max-w-[900px] 3xl:max-w-[980px] w-full lg:w-auto">
            {/* Logo */}
            <Link href="/" className="flex items-center lg:mb-0">
              <Image
                ...
                width={143}
                height={32}
                className="lg:h-[32px] 2xl:h-[56px] 3xl:h-[70px] w-[103px] lg:h-8 lg:w-auto object-contain"
              />
            </Link>
            ...
            <div className="hidden lg:flex flex-col gap-1 text-[14px] 2xl:text-[22px] 3xl:text-[27px] leading-[160%] text-[#737AAE]">
          ...
          <div className="flex gap-[80px] lg:gap-[80px] 2xl:gap-[160px] 3xl:gap-[196px]">
            {/* Navigation Column */}
            <div className="flex flex-col items-start gap-[7px] 2xl:gap-[14px] 3xl:gap-[20px]">
              <h3 className="text-[14px] lg:text-[18px] 2xl:text-[30px] 3xl:text-[35px] leading-[20px] lg:leading-[26px] 2xl:leading-[40px] 3xl:leading-[45px] font-semibold text-white">
                Navigation
              </h3>
              <nav className="flex flex-col gap-[5px] 2xl:gap-[12px] 3xl:gap-[17px]">
                <Link 
                  href="/" 
                  className="text-[12px] lg:text-[14px] 2xl:text-[22px] 3xl:text-[27px] leading-[160%] text-white/50 hover:text-white transition-colors"
                >
                  Home
                </Link>
                <Link 
