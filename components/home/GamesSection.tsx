...
function GameCard({ title, description, imageSrc, className = '', href }: GameCardProps) {
  return (
    <Link 
      href={href}
      className={`relative bg-[#0A0218] rounded-[30px] p-[30px] 2xl:p-[40px] hover:scale-[1.02] transition-transform overflow-hidden block ${className}`}
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-[10px]">
        <h3 
          className="text-[16px] lg:text-[24px] 2xl:text-[32px] leading-[19px] lg:leading-[29px] 2xl:leading-[40px] font-bold text-white"
          style={{ fontFamily: 'var(--font-hywenhei, system-ui)' }}
        >
          {title}
        </h3>
        <p className="text-[12px] lg:text-[14px] 2xl:text-[18px] leading-[160%] text-[#737AAE]">
          {description}
        </p>
      </div>
    </Link>
...
export function GamesSection() {
  return (
    <section className="w-full flex items-center justify-center px-4 lg:px-[10%] py-[30px] lg:py-[50px] 2xl:py-[70px]">
      <div className="w-full max-w-[1132px] lg:max-w-none flex flex-col gap-[25px] 2xl:gap-[35px]">
        {/* Header */}
        <div className="w-full flex flex-col lg:flex-row items-center lg:items-center lg:justify-between gap-[10px] lg:gap-0">
          <h2 
            className="text-[24px] lg:text-[36px] 2xl:text-[48px] leading-[29px] lg:leading-[44px] 2xl:leading-[56px] font-bold text-white text-center lg:text-left"
            style={{ fontFamily: 'var(--font-hywenhei, system-ui)' }}
          >
            Choose Your Dream!
          </h2>
          <p className="hidden lg:block text-[12px] lg:text-[14px] 2xl:text-[18px] leading-[160%] text-[#737AAE] max-w-[356px] 2xl:max-w-[450px] text-center lg:text-left">
        ...
        <GameCard
          ...
          className="w-full h-[auto] lg:h-[210px] 2xl:h-[280px]"
          href="/payment/genshin-impact"
        />

        {/* Wuthering Waves + Zenless Zone Zero */}
        <div className="flex flex-col lg:flex-row gap-[25px] 2xl:gap-[35px]">
          <GameCard
            ...
            className="w-full lg:w-[57%] h-[auto] lg:h-[231px] 2xl:h-[300px]"
          ...
          <GameCard
            ...
            className="w-full lg:w-[43%] h-[auto] lg:h-[231px] 2xl:h-[300px]"
        ...
        <div className="flex flex-col lg:flex-row gap-[25px] 2xl:gap-[35px]">
          <GameCard
            ...
            className="w-full lg:w-[40%] h-[231px] 2xl:h-[300px]"
          ...
          <GameCard
            ...
            className="w-full lg:w-[60%] h-[auto] lg:h-[231px] 2xl:h-[300px]"
        ...
        <Link 
          href="/products" 
          className="text-[16px] 2xl:text-[20px] leading-[160%] text-[#737AAE] hover:text-white transition-colors font-medium self-center mt-[15px]"
        >
          See All
        </Link>
      </div>
