...
function GameCard({ title, description, imageSrc, className = '', href }: GameCardProps) {
  return (
    <Link 
      href={href}
      className={`relative bg-[#0A0218] rounded-[30px] 2xl:rounded-[50px] 3xl:rounded-[70px] p-[30px] 2xl:p-[60px] 3xl:p-[80px] hover:scale-[1.02] transition-transform overflow-hidden block ${className}`}
      style={{
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col gap-[10px] 2xl:gap-[20px] 3xl:gap-[30px]">
        <h3 
          className="text-[16px] lg:text-[24px] 2xl:text-[40px] 3xl:text-[56px] leading-[19px] lg:leading-[29px] 2xl:leading-[50px] 3xl:leading-[68px] font-bold text-white"
          style={{ fontFamily: 'var(--font-hywenhei, system-ui)' }}
        >
          {title}
        </h3>
        <p className="text-[12px] lg:text-[14px] 2xl:text-[24px] 3xl:text-[32px] leading-[160%] text-[#737AAE]">
          {description}
        </p>
      </div>
    </Link>
...
export function GamesSection() {
  return (
    <section className="w-full flex items-center justify-center px-4 lg:px-[20%] py-[30px] lg:py-[50px] 2xl:py-[100px] 3xl:py-[140px]">
      <div className="w-full max-w-[1132px] lg:max-w-none flex flex-col gap-[25px] 2xl:gap-[50px] 3xl:gap-[70px]">
        {/* Header */}
        <div className="w-full flex flex-col lg:flex-row items-center lg:items-center lg:justify-between gap-[10px] lg:gap-0">
          <h2 
            className="text-[24px] lg:text-[36px] 2xl:text-[60px] 3xl:text-[80px] leading-[29px] lg:leading-[44px] 2xl:leading-[72px] 3xl:leading-[96px] font-bold text-white text-center lg:text-left"
            style={{ fontFamily: 'var(--font-hywenhei, system-ui)' }}
          >
            Choose Your Dream!
          </h2>
          <p className="hidden lg:block text-[12px] lg:text-[14px] 2xl:text-[24px] 3xl:text-[32px] leading-[160%] text-[#737AAE] max-w-[356px] 2xl:max-w-[600px] 3xl:max-w-[800px] text-center lg:text-left text-nowrap">
        ...
        <GameCard
          ...
          className="w-full h-[auto] lg:h-[210px] 2xl:h-[350px] 3xl:h-[480px]"
          href="/payment/genshin-impact"
        />

        {/* Wuthering Waves + Zenless Zone Zero */}
        <div className="flex flex-col lg:flex-row gap-[25px] 2xl:gap-[50px] 3xl:gap-[70px]">
          <GameCard
            ...
            className="w-full lg:w-[57%] h-[auto] lg:h-[231px] 2xl:h-[380px] 3xl:h-[520px]"
          ...
          <GameCard
            ...
            className="w-full lg:w-[43%] h-[auto] lg:h-[231px] 2xl:h-[380px] 3xl:h-[520px]"
        ...
        <div className="flex flex-col lg:flex-row gap-[25px] 2xl:gap-[50px] 3xl:gap-[70px]">
          <GameCard
            ...
            className="w-full lg:w-[40%] h-[231px] 2xl:h-[380px] 3xl:h-[520px]"
          ...
          <GameCard
            ...
            className="w-full lg:w-[60%] h-[auto] lg:h-[231px] 2xl:h-[380px] 3xl:h-[520px]"
        ...
        <Link 
          href="/products" 
          className="text-[16px] 2xl:text-[28px] 3xl:text-[36px] leading-[160%] text-[#737AAE] hover:text-white transition-colors font-medium self-center mt-[15px] 2xl:mt-[30px] 3xl:mt-[40px]"
        >
          See All
        </Link>
      </div>
